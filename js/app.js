(() => {
          ...
          void 0 !== n &&
            ...
            (k(t[i]) && k(l[i])
              ? l[i].__swiper__
                ...
                : A(t[i], l[i])
              : !k(t[i]) && k(l[i])
              ? ((t[i] = {}), l[i].__swiper__ ? (t[i] = l[i]) : A(t[i], l[i]))
              : (t[i] = l[i]));
        }
      }
    }
      ...
      if (
        ...
        if (0 === t) r[e ? "scrollLeft" : "scrollTop"] = -d;
          ...
          if (!l.support.smoothScroll)
            return (
              P({ swiper: l, targetPosition: -d, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
      ...
      if (r.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!l.support.smoothScroll)
            return (
              P({ swiper: l, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  class re {
    constructor(...e) {
      ...
      (i.__swiper__ = !0),
        (i.support = z()),
        (i.device = D({ userAgent: s.userAgent })),
        (i.browser = B()),
        (i.eventsListeners = {}),
    ...
    t({
      ...
      s("click", (t, s) => {
        const { $nextEl: n, $prevEl: l } = e.navigation,
          a = s.target;
        if (e.params.navigation.hideOnClick && !T(a).is(l) && !T(a).is(n)) {
          if (
            e.pagination &&
            e.params.pagination &&
  ...
  function ue({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (c.find(pe(s.currentClass)).text(s.formatFractionCurrent(d + 1)),
          c.find(pe(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let t;
    ...
    function d() {
      ...
      if ("bullets" === t.type) {
        ...
        n.html(l), (e.pagination.bullets = n.find(pe(t.bulletClass)));
      }
      "fraction" === t.type &&
        ((l = t.renderFraction
  ...
  window.addEventListener("load", function (e) {
    he(),
      document.querySelector(".customer__slider") &&
        new oe(".customer__slider", {
          modules: [de, ue],
          observer: !0,
          observeParents: !0,
          slidesPerView: 1,
          ...
          autoHeight: !0,
          speed: 800,
          pagination: { el: ".customer__controll", clickable: !0 },
          navigation: {
        ...
        function o(e) {
          ...
          if (t.closest("[data-spoller]")) {
            ...
            n.querySelectorAll("._slide").length ||
              (l && !s.classList.contains("_spoller-active") && c(n),
    ...
    (function () {
      ...
      function n(e, t) {
        e.forEach((e) => {
          ...
          e.querySelectorAll("[data-tabs-item]").forEach((l, a) => {
            t.matches
              ? (n.append(i[a]), n.append(l), e.classList.add("_tab-spoller"))
